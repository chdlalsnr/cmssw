...
void HBGEMGeometryValidator::analyze(const edm::Event& e, const edm::EventSetup& iSetup) {
  ...
  for (GEMRecHitCollection::const_iterator recHit = GEMRecHits->begin(); recHit != GEMRecHits->end(); ++recHit) {
	...
	if ( (deg > -5. && deg < 5.) || (deg > 25. && deg < 35.) || (deg > 45. && deg < 55.) || (deg > 65. && deg < 75.) || (deg > 85. && deg < 95.) || (deg > 105. && deg < 115.) || (deg > 125. && deg < 135.) || (deg > 145. && deg < 155.) || (deg > 165. && deg < 175.) || (deg > 185. && deg < 195.) || (deg > 205. && deg < 215.) || (deg > 225. && deg < 235.) || (deg > 245. && deg < 255.) || (deg > 265. && deg < 275.) || (deg > 285. && deg < 295.) || (deg > 305. && deg < 315.) || (deg > 325. && deg < 335.) || (deg > 345. && deg < 355.) ) {
	  if ( (pow(pow(globalX,2)+pow(globalY,2),.5)>130.2) && (pow(pow(globalX,2)+pow(globalY,2),.5)<236.3) ) {
	    ...
	    cout << "**********RECONSTRUCTION IN UNSENSITIVE REGION!!! @ region" << region << " station" << station << " chamber" << chamber << " layer" << layer << " **********" << endl;
	  }
	}
	else {
	  if ( (pow(pow(globalX,2)+pow(globalY,2),.5)>130.2) && (pow(pow(globalX,2)+pow(globalY,2),.5)<251.1) ) {
            x_r_1s1t.push_back(globalX);
            y_r_1s1t.push_back(globalY);
	  }
          else {
	...
	if ( (pow(pow(globalX,2)+pow(globalY,2),.5)>136.55) && (pow(pow(globalX,2)+pow(globalY,2),.5)<319.68) ) {
